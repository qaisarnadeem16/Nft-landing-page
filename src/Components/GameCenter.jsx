            ...
            <div className="py-10" id='game'>
                ...
                <div className="py-5 flex flex-wrap md:flex-row flex-col-reverse">
                    ...
                    <div className="md:w-[50%] w-full py-5  ">
                        ...
                        <div className="text-xl flex flex-col justify-center !items-center md:px-16  px-5 md:mt-10">

                            <p className="text-2xl py-3">Whatever your interests may be, there's sure to be something for you in the Metaverse. From action-packed adventure games to mystical worlds of fantasy, everything is available at your fingertips. </p>

                            <p className="text-2xl py-3">So, don't wait any longer and join the Metaverse gaming world today. Immerse yourself in a new reality and explore endless possibilities. Let's check it out! </p>
